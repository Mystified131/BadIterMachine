...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Sequence" in str(filepath))  and ("Chill" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
                contentdrones.append(filepath)

        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Chill" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
        ...
        if  filepath.endswith(".wav") and ("Fx" in str(filepath)) and ("Chill" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
                contentsax.append(filepath)

        if  filepath.endswith(".wav") and  ("Keys" in str(filepath)) and ("Chill" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
