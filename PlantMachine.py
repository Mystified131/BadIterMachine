...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Percussion" in str(filepath)) and ("Ambi" in str(filepath)) :            
            contentperc.append(filepath)

        if  filepath.endswith(".wav") and ("Drum" in str(filepath)) or ("Beat" in str(filepath))  and ("Acoustic" in str(filepath)): 
        ...
        if  filepath.endswith(".wav") and ("Sleep" in str(filepath)) and ("Pad" in str(filepath)) :
            contentorg.append(filepath)

        if  filepath.endswith(".wav") and ("Fx" in str(filepath)) and ("Ambi" in str(filepath))  :
            contentsax.append(filepath)

        if  filepath.endswith(".wav") and ("Keys" in str(filepath)) and ("Sleep" in str(filepath))  :
            contentgit.append(filepath)

        if  filepath.endswith(".wav") and ("Nature" in str(filepath)):
