...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Ripped" in str(filepath)) and ("Vinyl" in str(filepath)):
             
            contentbass.append(filepath)

        if  filepath.endswith(".wav")  and ("Acid_Loops" in str(filepath)) and ("Groove" in str(filepath))  and ("ZZ Indie" not in str(filepath)) :  
...
# generiter -L baditer.json -C composen.json
