...
for subdir, dirs, files in os.walk(srchstr):
    for file in files:
        ...
        if  filepath.endswith(".wav") and ("Drum" in str(filepath)) and ("Trance" in str(filepath)): 
        ...
        if  filepath.endswith(".wav") and ("Bass" in str(filepath)) and ("Trance" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
        ...
        if  filepath.endswith(".wav") and ("Drone" in str(filepath)) and ("Low" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
                contentsax.append(filepath)

        if  filepath.endswith(".wav") and  ("Pad" in str(filepath)) and ("Trance" in str(filepath)) :
            if int(os.stat(filepath).st_size) < sizlim:  
                contentgit.append(filepath)

        if  filepath.endswith(".wav") and ("Fx" in str(filepath)) and ("Trance" in str(filepath)):
            if int(os.stat(filepath).st_size) < sizlim:  
